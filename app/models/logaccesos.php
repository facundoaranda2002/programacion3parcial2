...
class logaccesos
{
    ...
    public function crearAcceso()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO logaccesos (idUsuario ,rol, nombreUsuario, password) VALUES ( :idUsuario, :rol, :nombreUsuario, :password)");
    ...
    */
    ...
    public static function obtenerTodos()
    {
        ...
        return $consulta->fetchAll(PDO::FETCH_CLASS, 'logaccesos');
    }

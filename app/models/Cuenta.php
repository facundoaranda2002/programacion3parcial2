...
class Cuenta
{
    ...
    public function ModificarMontoCuenta()
    {
        ...
        $consulta = $objAccesoDato->prepararConsulta("UPDATE cuentas SET monto = :monto WHERE nroDeCuenta = :nroDeCuenta AND tipoDeCuenta = :tipoDeCuenta AND estaActivo = true");
        $consulta->bindValue(':tipoDeCuenta', $this->tipoDeCuenta, PDO::PARAM_STR);
